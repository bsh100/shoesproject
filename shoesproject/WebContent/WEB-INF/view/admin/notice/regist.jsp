...
<script>
   ...
   function insert() {
      $("form input[name='noticeContent']").val(CKEDITOR.instances["detail"].getData());
...
<body>
   ...
   <div class="registBox">
      <form>
         <label>제목</label> 
         <input type="text" id="noticeTitle" name="noticeTitle" placeholder="제목을 입력해 주세요"> 
         <label>작성자</label> 
         <input type="text" id="noticeWriter" name="noticeWriter" value="<%=userId%>" readonly="readonly">
         <label>내용</label>
