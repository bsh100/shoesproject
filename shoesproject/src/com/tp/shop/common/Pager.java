...
//재사용을 위해 페이징 처리 https://blog.naver.com/PostView.nhn?blogId=qjawnswkd&logNo=222049465602
@Component //어노테이션 컴포턴트를 사용하면서 빈등록 할수잇도록 해줌
public class Pager {
	private List list;
